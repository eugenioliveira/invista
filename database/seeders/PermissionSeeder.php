...
class PermissionSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Permission::create([
            'name' => 'view_allotments',
            'description' => 'Permissão para listar todos os loteamentos.'
        ]);
        Permission::create([
        ...
        Permission::create([
            'name' => 'create_lots',
            'description' => 'Permissão para criar um novo lote.'
        ]);
        Permission::create([
            'name' => 'edit_lot',
            'description' => 'Permissão para alterar as informações de um lote.'
        ]);
        Permission::create([
            'name' => 'import_lots',
            'description' => 'Permissão para importar lotes via excel.'
        ]);
        Permission::create([
            'name' => 'view_users',
            'description' => 'Permissão para listar usuários do sistema.'
        ]);
        Permission::create([
            'name' => 'edit_user',
            'description' => 'Permissão para editar um usuário do sistema.'
        ]);
        Permission::create([
            'name' => 'create_user',
            'description' => 'Permissão para criar um usuário do sistema.'
        ]);
        Permission::create([
            'name' => 'view_people',
        ...
        Permission::create([
            ...
            'description' => 'Permissão para visualizar as reservas do sistema'
        ]);
        Permission::create([
            'name' => 'make_reservation',
            'description' => 'Permissão para reservar um lote no sistema.'
        ]);
        Permission::create([
            'name' => 'propose',

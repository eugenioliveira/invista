<div>
    ...
    <div class="flex justify-center mb-2 space-x-2 items-end">
        <x-input.group :inline="true" for="postal_code" label="CEP" :error="$errors->first('postal_code')">

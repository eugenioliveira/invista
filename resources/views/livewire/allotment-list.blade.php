                    ...
                    <div class="h-full flex flex-col space-y-6 py-6 bg-white shadow-xl">
                        ...
                        <div class="relative flex-1 px-4 sm:px-6">
                            ...
                            <ul>
                                ...
                                <!-- Lots -->
                                <li>
                                    <a :href="'/allotments/' + allotmentId + '/lots'" class="flex items-center px-4 py-2 rounded-lg hover:bg-orange-500 hover:text-white">
                                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                  d="M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z"></path>
                                        </svg>
                                        <span class="ml-2">Gerenciar lotes</span>
                                    </a>
                                </li>
                                <!-- Brokers -->
                                <li>

    ...
    <x-slide-over wire:model.defer="showOptionsPanel">
        ...
        <x-slot name="body">
            <ul>
                ...
                @can('edit_allotment')
                    <li>
                        <a href="{{ $currentAllotment->id ? route('allotment.payment-plans', $currentAllotment->id) : '' }}" class="flex items-center px-4 py-2 rounded-lg hover:bg-yellow-500 hover:text-white">

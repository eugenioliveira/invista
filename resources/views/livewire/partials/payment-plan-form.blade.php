...
@if($installmentIndexes->isNotEmpty())
        ...
        <tr>
            ...
            <td class="px-6 py-4 whitespace-no-wrap flex space-x-3">
                ...
                @else
                    ...
                    <x-button type="button" wire:click="clearIndexState">
                        Cancelar
                    </x-button>
                @endif
            </td>
...
@else
    <x-alert type="warning" message="Nenhum índice cadastrado ainda." :autoclose="false"></x-alert>
@endif
...
@error('installment_indexes.*')
<x-alert type="danger" message="{{ $message }}" :autoclose="false"></x-alert>
@enderror

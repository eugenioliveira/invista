<x-card class="p-4 max-w-3xl mx-auto">
    ...
    <form wire:submit.prevent="updateLot">
        ...
        <x-input-row>
            ...
            <x-button type="button" wire:click="uodateLot(false)">Salvar e Continuar</x-button>
            <x-button-link type="danger" href="{{ route('lots.index', $lot->id) }}">Cancelar</x-button-link>
        </x-input-row>
    </form>

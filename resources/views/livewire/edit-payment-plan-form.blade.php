<x-card class="p-4 max-w-3xl mx-auto">
    ...
    <form>
        ...
        <x-input-row class="mt-6 flex flex-col space-y-2 md:space-y-0 md:flex-row">
            <x-button type="button" wire:click="updatePaymentPlan">Salvar e Voltar</x-button>
            <x-button type="button" wire:click="updatePaymentPlan(false)">Salvar e Continuar</x-button>

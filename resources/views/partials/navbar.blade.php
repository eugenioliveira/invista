        ...
        >
            ...
            @can('view_allotments')
                <x-mobile-nav-dropdown title="Loteamentos" route="allotments">
                    <x-mobile-nav-dropdown-link href="{{ route('allotments.index') }}">Listar</x-mobile-nav-dropdown-link>
                    @can('create_allotment')
                        <x-mobile-nav-dropdown-link href="{{ route('allotment.create') }}">Novo</x-mobile-nav-dropdown-link>
                    @endcan
            ...
            @can('view_people')
                <x-mobile-nav-dropdown title="Pessoas físicas" route="person">
                    ...
                    @can('create_person')
                        <x-mobile-nav-dropdown-link href="{{ route('person.create') }}">Novo</x-mobile-nav-dropdown-link>
                    @endcan
                </x-mobile-nav-dropdown>
            @endcan
            @can('view_companies')
            ...
            @can('manage_payment_plans')
                <x-mobile-nav-dropdown title="Planos" route="payment-plans">
                    <x-mobile-nav-dropdown-link href="{{ route('payment-plans.index') }}">Listar</x-mobile-nav-dropdown-link>
                </x-mobile-nav-dropdown>
            @endcan
